			...
			<div class="main-page">
				<div class="tables">
					...
					<div class="table-responsive bs-example widget-shadow">
						...
						<table class="table table-bordered"> <thead> <tr> <th>#</th> <th>Nome du salle</th> <th>Taille</th> <th>Date de creation</th><th>Action</th> </tr> </thead> <tbody>
<?php
...
?>
						 ...
						 <tr> <th scope="row"><?php echo $cnt;?></th> <td><?php  echo $row['ServiceName'];?></td> <td><?php  echo $row['ability'];?></td><td><?php  echo $row['CreationDate'];?></td> <td>
