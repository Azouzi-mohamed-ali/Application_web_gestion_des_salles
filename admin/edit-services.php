...
if(isset($_POST['submit']))
 ...
 $eid=$_GET['editid'];
    ...
    $query=mysqli_query($con, "update  tblservices set ServiceName='$sername',ServiceDescription='$serdesc',ability='$ability' where ID='$eid' ");
    if ($query) {
...
?>
							 ...
							 <div class="form-group"> <label for="exampleInputPassword1">ability</label> <input type="text" id="ability" name="ability" class="form-control" placeholder="ability" value="<?php  echo $row['ability'];?>" required="true"> </div>
