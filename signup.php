...
echo "<script>alert('This email or Contact Number already associated with another account!.');</script>";
    ...
    $query=mysqli_query($con, "insert into tbluser(FirstName, LastName,type ,  MobileNumber, Email, Password) value('$fname', '$lname','$type','$contno', '$email', '$password' )");
    if ($query) {
                    ...
                    <form method="post" name="signup" onsubmit="return checkpass();">
                        <div style="padding-top: 30px;">
                         ...
                         <div style="padding-top: 30px;">
                          ...
                          <select class="form-control" name="type"  placeholder="profile type" required="">
